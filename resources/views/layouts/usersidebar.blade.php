<div class="dashboard_menu">
    <ul class="nav nav-tabs flex-column" role="tablist">
        ...
        <!--li class="nav-item">
            <a class="nav-link  {{  request()->routeIs('user.addcompany') ? 'active' : '' }}" href="{{ route("user.addcompany") }}"><i class="ti-map-alt"></i>Add Company</a>
        </li-->
        @else
        <!--li class="nav-item">
            <a class="nav-link  {{  request()->routeIs('user.company') ? 'active' : '' }}" href="{{ route("user.company") }}"><i class="ti-map-alt"></i>Company Profile</a>
        </li-->
        @endif
        <li class="nav-item">
