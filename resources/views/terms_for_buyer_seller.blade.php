...
@section('title')
    <title>{{ config('app.name', 'Industry2u') .  __(' TERMS FOR BUYERS &amp; SELLERS') }}</title>
@endsection
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="page-title">
                        <h1>TERMS FOR BUYERS &amp; SELLERS</h1>
                    </div>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb justify-content-md-end" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="breadcrumb-item active">TERMS FOR BUYERS &amp; SELLERS</li>
                    </ol>
