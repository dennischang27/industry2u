                            ...
                            <div class="card-body">
                                <form id="bankinfoform" novalidate class="form" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control @error('bank_account') is-invalid @enderror" value="{{old('bank_account')}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input pattern="[0-9]+" class="form-control @error('sst_no') is-invalid @enderror" value="{{old('sst_no')}}"
