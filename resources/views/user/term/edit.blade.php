                ...
                <div class="col-lg-9 col-md-8">
                    <div class="dashboard_content">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="term_form" action="{{ route('user.term.update',$term->id) }}" class="form" method="post">
                                    @csrf
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group row">
                                            <label for="name" class="col-sm-3 col-form-label"><strong>Code:</strong><small class="text-danger">*</small></label>
                                            <div class="col-sm-9">
                                                <input type="text" required  value="{{ $term->code }}" class="form-control @error('code') is-invalid @enderror" id="code" name="code"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" required  value="{{$term->description}}" class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" required  value="{{$term->days}}" class="form-control @error('days') is-invalid @enderror" id="days" name="days"
                                                       placeholder="Eg:30"
