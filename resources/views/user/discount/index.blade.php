                            ...
                            <div class="card-body">
                                ...
                                @if ($discount->manager_tier1 != null && $discount->manager_tier2 != null && $discount->manager_tier3 != null)
                                    <table class="table" class="text-center">
                                        ...
                                        <tbody>
                                            <th>{{$discount->manager_tier1}}</th>
                                            <th>{{$discount->manager_tier2}}</th>
                                            <th>{{$discount->manager_tier3}}</th>
                
                                            <td>
                                                <a class="btn btn-primary btn-xs" style="color: white;"
                                                href="{{ route('user.discount.manager')}}">Edit</a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>    
                                ...
                                @else
                                    <a class="btn btn-primary btn-sm" style="color: white;" href="{{ route('user.discount.manager') }}">Add Manager Discount Setting</a>
                                    <br>
                                @endif
