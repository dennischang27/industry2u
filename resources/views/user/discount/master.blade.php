                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input style="height: 40px" class="form-control" name="master_tier1" placeholder="discount tier 1" title="" required> 
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input style="height: 40px" class="form-control" name="master_tier2" placeholder="discount tier 2" title="" required>
                                                    </div>
                                                    <div style="margin-top: 0.5%">
                                                        <h4>%</h4>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input style="height: 40px" class="form-control" name="master_tier3" placeholder="discount tier 3" title="" required>
                                                    </div>
                                                    <div style="margin-top: 0.5%">
                                                        <h4>%</h4>
                                                    </div>
