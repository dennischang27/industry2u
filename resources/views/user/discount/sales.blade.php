                ...
                <div class="col-lg-9 col-md-8">
                    <div class="dashboard_content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{route('user.discount.sales')}}">
                                    @csrf        
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input style="height: 40px" class="form-control" name="sales_tier1" placeholder="discount tier 1" value="{{ $discount->sales_tier1}}" required> 
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input style="height: 40px" class="form-control" name="sales_tier2" placeholder="discount tier 2" value="{{ $discount->sales_tier2 }}" required>
                                                    </div>
                                                    <div style="margin-top: 0.5%">
                                                        <h4>%</h4>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input style="height: 40px" class="form-control" name="sales_tier3" placeholder="discount tier 3" value="{{ $discount->sales_tier3 }}" required>
                                                    </div>
                                                    <div style="margin-top: 0.5%">
                                                        <h4>%</h4>
                                                    </div>
